                ...
                <nav class="navbar navbar-inverse">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <a class="navbar-brand" href="userLandingPage.html" style="color:rgb(10, 153, 197);">Grit Stock Exchange</a>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="margin-left: 18%;">
                                <div style="margin-left:25%;">
                                    <img src="img/success.gif" alt="Success" height="100px" width="100px"><h2 style="margin-left: -30%; margin-top: 5%;color: rgba(22, 156, 44, 0.486);">Successfully Submitted</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="upload-btn-wrapper" style="margin-top: 10%">
                                        ...
                                        <div>    
                                                <table class="table">
                                                  <tbody>
                                                    <tr>
                                                      <td><img src="img/cognizant.jpg" alt="Logo" height="40px" width="40px"></td>  
                                                      <td>Cognizant</td>
                                                      <td>BSE, NSE</td>
